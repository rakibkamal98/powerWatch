...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top"><img src="img/logo.png" alt="" height="50" width="50"> Power Watch</a>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <h1 class="brand-heading">Power Watch </h1>
            
              <p class="intro-text">It's time to charge!
                <br>
                A stylish watchcase that protects and charges your smartwatch on the go.
             </p>
    ...
    <section id="about" class="content-section text-center">
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <h1>What is Power Watch?</h1>
            <ul style="text-align: left;"><font size="5">
            <li style="padding-bottom: 50px">Keeps your smartwatch charged all throughout the day</li>
            <li style="padding-bottom: 50px">Models for both Apple and Samsung watches </li>
            <li style="padding-bottom: 50px">Variety of fashionable designs </li>
            <li style="padding-bottom: 50px">Easy to recharge and long lasting</li>
          </font>
          </ul>
          </div>
        </div>
    ...
    <section id="download" class="download-section content-section text-center">
      <div class="container">
        <div class="col-lg-8 mx-auto">
          <h2>Shopping</h2>
          <p>Choose from a wide selection of designs and models here</p>
          <a href="Shoppage.html" class="btn btn-default btn-lg">Shop</a>
        </div>
      </div>
    </section>
