  ...
  <div class="container-sign">
    <form action="infosend.php" method="POST"> 
      <form class="form-signin">
        ...
        <center><a><?php echo $_GET['welcomeMessage'];?></a></center>
        ...
        <input type="email" id="inputEmail" class="form-control" name="Email" pattern="(?:[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*|&quot;(?:[\x01-\x08\x0b\x0c\x0e-\x1f\x21\x23-\x5b\x5d-\x7f]|\\[\x01-\x09\x0b\x0c\x0e-\x7f])*&quot;)@(?:(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?|\[(?:(?:(2(5[0-5]|[0-4][0-9])|1[0-9][0-9]|[1-9]?[0-9]))\.){3}(?:(2(5[0-5]|[0-4][0-9])|1[0-9][0-9]|[1-9]?[0-9])|[a-z0-9-]*[a-z0-9]:(?:[\x01-\x08\x0b\x0c\x0e-\x1f\x21-\x5a\x53-\x7f]|\\[\x01-\x09\x0b\x0c\x0e-\x7f])+)\])" required autofocus>
        ...
        <a>City:</a>
        <input type="city" id="inputCity" class="form-control" pattern="[a-zA-Z][a-zA-Z ]{1,}" name="City" autofocus required title="City must contain only letters and spaces!">
<!--
        <label for="inputState" class="sr-only">State</label>
        <input type="state" id="inputState" class="form-control" placeholder="State" name="State" required>
-->
        <a>State:</a>
        <select type="state" id="inputState" class="form-control" name="State" >
        ...
        <a>Zip Code:</a>
        <input type="zipcode" id="inputZipcode" class="form-control" name="Zipcode" pattern="^\d{5}(?:[-\s]\d{4})?$" autofocus required title="Must be a valid zipcode!">
